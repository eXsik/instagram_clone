            ...
            <div class="w-full md:flex h-full overflow-auto rounded-xl">
                ...
                <div class="md:max-w-[500px] w-full relative">
                    <div class="flex items-center justify-between p-3 border-b">
                        ...
                        <button v-if="user.id === post.user.id" @click="$event => {
                            deleteType = 'Post';
                            id = post.id;
                        }">
                    ...
                    <div class="overflow-y-auto h-[calc(100%-170px)]">
                        ...
                        <div v-if="post.comments" class="p-3" v-for="comment in post.comments" :key="comment">
                            <div class="flex items-center justify-between">
                                ...
                                <DotsHorizontal v-if="user.id === comment.user.id" class="cursor-pointer" @click="$event => {
                                    deleteType = 'Comment';
                                    id = comment.id;
                                }" :size="27" />
                            </div>
                    ...
                    <div class="absolute flex border bottom-0 w-full max-h-[200px] bg-white overflow-auto">
                        ...
                        <button v-if="comment" class="text-blue-600 font-extrabold pr-4" @click="$event => {
