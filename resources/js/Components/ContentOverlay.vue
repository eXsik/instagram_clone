...
<template>
    <div class="flex items-center justify-center cursor-pointer relative" @mouseenter="$event => isHover = true"
        @mouseleave="$event => isHover = false" @click="$event => emit('selectedPost', postByUser)">
        <div v-if="isHover"
        ...
        <img class="aspect-square mx-auto z-0 object-cover cursor-pointer" :src="postByUser.file" alt="">
    </div>
</template>
