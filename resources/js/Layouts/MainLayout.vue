...
import HearthOutline from 'vue-material-design-icons/HeartOutline.vue';
    ...
    <div id="MainLayout" class="w-full h-screen">
        <div v-if="$page.url === '/'" id="TopNavHome"
            ...
            <div class="flex items-center justify-between h-full">
                <Link href="/">
                <img class="w-[105px] ml-6 cursor-pointer" alt="" src="/insta-logo.png">
                </Link>

                <div class="flex items-center w-[50%]">
                    <div class="flex items-center w-full bg-gray-100 rounded-lg">
                        <Magnify class="pl-4" fillColor="#8E8E8E" :size="27"></Magnify>
                        <input type="text" placeholder="Search"
                            class="bg-transparent w-full placeholder-[#8E8E8E] border-0 ring-0 focus:ring-0">
                    </div>

                    <HearthOutline class="pl-4 pr-3" fillColor="#000000" :size="27"></HearthOutline>
                </div>
            </div>
        </div>
        ...
        <div v-if="$page.url !== '/'" id="TopNavUser"
            ...
            <AccountPlusOutline :size="30" class="cursor-pointer px-4"></AccountPlusOutline>
        </div>

        <div id="SideNav" class="fixed h-full bg-white xl:w-[280px] w-[80px] md:block hidden border-r border-r-gray-300">
            <Link href="/">
            <img class="xl:hidden block w-[25px] mt-10 ml-[25px] mb-10 cursor-pointer" src="/insta-logo-small.png" alt="">
            <img class="xl:block hidden w-[120px] mt-10 ml-6 mb-10 cursor-pointer" src="/insta-logo.png" alt="">
            </Link>
        ...
        <div class="flex lg:justify-between bg-white h-full w-[100%-280px] xl:pl-[280px] lg:pl-[100px] overflow-auto">
            ...
            <div v-if="$page.url === '/'" id="SuggestionsSection" class="lg:w-4/12 lg:block hidden text-black mt-10">
                ...
                <div class="flex items-center">
                    <img class="rounded-full z-10 w-[58px] h-[58px]" :src="$page.props.auth.user.file" :alt="$page.props.auth.user.name + ' profile picture'">
                    <div class="pl-4">
               ...
               <div v-for="randomUser in $page.props.randomUsers" :key="randomUser">
                <Link :href="route('users.show', { id: randomUser.id})" class="flex items-center justify-between max-w-[300px] pb-2">
                <div class="flex items-center">
                    <img class="rounded-full z-10 w-[37px] h-[37px]" :src="randomUser.file" alt="">
                    <div class="pl-4">
        ...
        <div id="BottomNav"
            ...
            <Link :href="route('users.show', { id: $page.props.auth.user.id })">
            <img class="rounded-full w-[30px] cursor-pointer" :src="$page.props.auth.user.file" alt="">
            </Link>
        </div>
    </div>
